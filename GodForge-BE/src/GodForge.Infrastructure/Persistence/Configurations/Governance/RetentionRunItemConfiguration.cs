...
public sealed class RetentionRunItemConfiguration : IEntityTypeConfiguration<RetentionRunItem>
{
    public void Configure(EntityTypeBuilder<RetentionRunItem> builder)
    {
        ...
        builder.Property(i => i.Action).HasColumnName("action").HasMaxLength(30).IsRequired();
        ...
        builder.HasOne<RetentionRun>().WithMany().HasForeignKey(i => i.RetentionRunId).OnDelete(DeleteBehavior.Cascade);
    }
}
