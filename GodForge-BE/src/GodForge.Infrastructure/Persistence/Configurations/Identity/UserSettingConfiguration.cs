...
public sealed class UserSettingConfiguration : IEntityTypeConfiguration<UserSetting>
{
    public void Configure(EntityTypeBuilder<UserSetting> builder)
    {
        ...
        builder.Property(s => s.Theme).HasColumnName("theme").HasConversion<string>().HasMaxLength(20).IsRequired();
        ...
        builder.Property(s => s.NotificationDigest).HasColumnName("notification_digest").HasConversion<string>().HasMaxLength(20).IsRequired();
