...
<template>
    <div class="min-h-screen bg-[#09090b] flex flex-col lg:flex-row font-sans selection:bg-emerald-500/30 selection:text-emerald-100">
        <InteractiveDotGrid />
...
<style>
/* Base dark aesthetic body fallback */
body {
